...
class _ServiceViewState extends State<ServiceView> {
  ...
  Widget build(BuildContext context) {
    ...
    var _login = Provider.of<UserLogin>(context, listen: false);
              ...
              return Column(
                children: [
                  ...
                  CustomListTitle(
                    ...
                    text: S.of(context).blood_donate,
                    icon: Icons.bloodtype,
                  ),
                  CustomListTitle(
                    text: S.of(context).Find_blood_type,
                    onpressed: () {
                  ...
                  CustomListTitle(
                      text: S.of(context).My_Notification,
                      onpressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    onpressed: () {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            content: Text(S.of(context).Do_you_want_to_sign_out,
                                style: TextStyle(fontWeight: FontWeight.bold)),
                            actions: [
                              MaterialButton(
                                  onPressed: () async {
                                    _login.toggleUSerState();

                                    Navigator.pushAndRemoveUntil(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              JoinBloodDonationApp(),
                                        ),
                                        (route) => false);
                                  },
                                  child: Text(
        ...
        child: isLoading
            ...
            : Column(
                children: [
                  ...
                  Text(
                    S.of(context).Blood_Locator_Donation,
                    style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),
                  ),
                  Text(
                    S.of(context).Choose_the_service_you_want,
                  ),
                  const SizedBox(
                    height: 30,
                  ),
                  CustomButton(
                      ...
                      text: S.of(context).Donate_blood),
                  const SizedBox(
                    height: 20,
                  ),
                  CustomButton(
