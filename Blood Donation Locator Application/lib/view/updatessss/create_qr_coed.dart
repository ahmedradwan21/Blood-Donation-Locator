              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      labelText: S.of(context).Donor_Name),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      border: OutlineInputBorder(),
                      labelText: S.of(context).National_ID),
                  onChanged: (value) =>
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      enabled: false,
                      labelText:
                          '${S.of(context).Serial_Num} : ' + donar.serialNum),
                  onChanged: (value) => setState(() {
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(),
                      labelText:
                          '${S.of(context).Expired} : ' + donar.expiredDate),
                  onChanged: (value) => setState(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      border: OutlineInputBorder(),
                      labelText: S.of(context).add_more_data),
                  onChanged: (value) =>
                ...
                DropdownButtonFormField(
                  ...
                  decoration: InputDecoration(
                      border: OutlineInputBorder(),
                      labelText: S.of(context).Blood_Type),
                ),
                const SizedBox(height: 20),
                ElevatedButton(
